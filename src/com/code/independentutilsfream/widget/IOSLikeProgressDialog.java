...
public class IOSLikeProgressDialog extends Dialog {
    private static final String TAG = IOSLikeProgressDialog.class.getSimpleName();
    ...
    public IOSLikeProgressDialog(Context context) {
        super(context, R.style.Theme_CustomDialog);
        init(context);
    }

    public IOSLikeProgressDialog(Context context, int theme) {
        super(context, theme);
        init(context);
    }

    public IOSLikeProgressDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
    ...
    public void init(Context context){
        ...
        layout = (LinearLayout)inflater.inflate(R.layout.progress,null);
